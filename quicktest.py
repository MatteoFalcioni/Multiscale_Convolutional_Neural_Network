...
generate_multiscale_grids(data_array=remapped_array, window_sizes=args.window_sizes, grid_resolution=128, channels=10, save_dir='tests/test_grid_gen_onPC', save=True)
end_time = time.time()
