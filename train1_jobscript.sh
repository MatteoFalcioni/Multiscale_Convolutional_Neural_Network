...
srun python -u main.py --dataset_filepath 'data/training_data/21/train_21.csv' --training_data_filepath 'data/training_data/21/train_21.csv' --batch_size 32 --num_workers 32 --window_sizes '[10, 20 ,30]' --features_to_use intensity red green blue nir delta_z N_h mad l1 l2 l3 theta theta_variance --epochs 10 --patience 2

echo "training model on **train 21** with window sizes [10, 20, 30] and features: [intensity red green blue nir delta_z N_h mad l1 l2 l3 theta theta_variance]"