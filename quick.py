...
input_file = 'data/training_data/overfitting_test/train/sampled_rebalanced_data.csv'
...
sampled_array = sample_data(input_file=input_file, sample_size=500000, save_dir='data/training_data/overfitting_test/train/', save=True)

sampled_file = 'data/training_data/overfitting_test/train/sampled_data_500000.csv'

file_to_read = sampled_file
