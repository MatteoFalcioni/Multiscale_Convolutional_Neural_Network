...
# sampled_array = sample_data(input_file=input_file, sample_size=500000, save_dir='data/training_data/overfitting_test/inference/', save=True)

# sampled_file = 'data/training_data/overfitting_test/inference/sampled_data_500000.csv'
