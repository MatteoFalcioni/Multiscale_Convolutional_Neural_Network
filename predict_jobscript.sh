...
srun python -u main.py --predict_labels --file_to_predict 'data/chosen_tiles/32_680000_4928500_FP21.las'  --load_model_filepath 'models/saved/mcnn_model_20241212_035207/model.pth' --batch_size 32 --num_workers 32 

echo "Predicted labels on file: data/chosen_tiles/32_680000_4928500_FP21.las"