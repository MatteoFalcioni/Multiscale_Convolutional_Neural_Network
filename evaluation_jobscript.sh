...
srun python -u main.py --perform_evaluation --load_model_filepath 'models/saved/mcnn_model_20241116_143003/model.pth' --dataset_filepath 'data/training_data/21/test_21.csv' --evaluation_data_filepath 'data/training_data/21/test_21.csv' --batch_size 32 --num_workers 32 

echo "Evaluate best model on test_21"